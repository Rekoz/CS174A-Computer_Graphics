...
var texture_filenames_to_load = [ "stars.png", "text.png", "earth.tga", "earthmap1k.png", "metal.jpg", "solarpanel.jpg", "sun.jpg", "starmap.jpg" ];
...
{	this.string_map = { };	this.m_text = new text_line( 20 ); 		this.start_index = 0;	this.tick = 0;
	...
	{
		debug_screen_object.string_map["tick"] = "FPS: " + this.fps;
